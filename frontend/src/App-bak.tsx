...
function AppBak() {
  ...
  const swapTitleName = (name: string) => {
    ...
    const current = titleNameElement.querySelector(
      ...
      <main className="container">
        <header className="brand">
          <a
            ...
            aria-label="Wails website"
          >
            <img src="/wails.png" className="brand-logo" alt="Wails logo" />
          </a>
          <a
            className="brand-badge"
            data-wml-openURL="https://reactjs.org"
            aria-label="React"
          >
        ...
        <div className="greet">
          <div className="input-box">
            ...
            <input
              ...
              autoComplete="off"
            />
            <button aria-label="greet-btn" className="btn" onClick={doGreet}>
              Greet
              <svg
                viewBox="0 0 24 24"
                fill="none"
